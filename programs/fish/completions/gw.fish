# completions for "gw" - git repo switcher for work repositories (git fallback).
# 1st arg: folder / project. "optional", "gw" will automatically fetch a repo if the folder shouldn't exist.
complete --command gw --exclusive \
